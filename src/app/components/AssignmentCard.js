...
export default function AssignmentCard({ assignment }) {
  ...
  return (
    <div className="bg-white border border-[#E5E7EB] rounded-lg shadow p-5 hover:border-[#10B981] transition">
      ...
      <Link
        ...
        className="inline-block mt-4 px-4 py-2 bg-[#10B981] hover:bg-[#059669] text-white text-sm font-semibold rounded transition-colors duration-200"
      >
        View Assignment
      </Link>
    </div>
